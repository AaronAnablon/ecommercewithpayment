    ...
    <div className="lg:min-h-screen relative">
      <Slider {...settings}>
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          <div className="w-full lg:w-1/3 hidden lg:inline-block bg-[#f6f5fa] h-full bg-designColor z-0 relative">
            <Image
              src={sliderOne}
              alt="sliderone"
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            ...
            <p className="w-96 text-center text-zinc-600">
              Browse Information Systems and get the one you dreamt
              for
            </p>
        ...
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          <div className="w-full lg:w-1/3 hidden lg:inline-block h-full bg-[#f6f5fa] z-0 relative">
            <Image
              src={sliderTwo}
              alt="sliderTwo"
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            <p className="text-xl uppercase">Get the Best products for you</p>
            <p className="w-96 text-center text-zinc-600">
              Browse the modern designs and get the one you dreamt
              for
            </p>
            <button className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">
              Select a Product
        ...
        <div className="w-full py-32 lg:py-0 lg:h-screen bg-slate-200 relative">
          ...
          <div className="lg:absolute lg:top-1/2 lg:left-2/3 transform lg:-translate-x-1/2 lg:-translate-y-1/2 flex flex-col items-center gap-5">
            <p className="text-xl uppercase">Get the Best products for you</p>
            <p className="w-96 text-center text-zinc-600">
              Browse the modern mobile/desktop applications and get the one you dreamt
              for
            </p>
            <p className="text-2xl font-semibold">Applications in Demand</p>
            <button className="text-base font-medium text-white bg-designColor rounded-md px-4 py-2">
              Select a Product
            </button>
          </div>
